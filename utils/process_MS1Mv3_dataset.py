...
def split_ms1mv3_by_open_class(input_file, classes, ratio=0.3, dataset='gldv2'):
...
def split_ms1mv3_by_open_data(input_file, classes, ratio=0.3, dataset='gldv2'):
    input_file = Path(input_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', default='../annotation/ms1mv3', type=str, help='')
    parser.add_argument('--split_file', default='../annotation/ms1mv3/label_93431.txt', type=str, help='')
